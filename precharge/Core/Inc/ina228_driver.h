...
#define INA228_ADDR1     (0x40 << 1)   // A1=GND, A0=GND // Motor1
#define INA228_ADDR2     (0x41 << 1)   // A1=GND, A0=VCC // Motor2
#define INA228_ADDR3     (0x42 << 1)   // A1=GND, A0=SDA // Motor3
#define INA228_ADDR4     (0x43 << 1)   // A1=GND, A0=SCL // Motor4
#define INA228_ADDR5     (0x44 << 1)   // A1=VCC, A0=GND // Bus
...
#define BUS_SHUNT_RESISTOR    			0.003f  	// 3 mOhm
...
/* Bus Calibration Constants */
#define MOTOR_SHUNT_RESISTOR    		0.006f  	// 6 mOhm
